...
━━━━━━━━━━━━━━━━━━
  ...
  return api.sendMessage(
    ...
    event.threadID, event.messageID
      ...
      if (event.senderID != "100070159519360") return api.sendMessage(`→ Đây là lệnh của admin bot`, event.threadID, event.messageID)
            let number = [];
