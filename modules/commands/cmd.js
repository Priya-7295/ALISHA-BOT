...
module.exports.run = function ({ event, args, api }) { const permission = ["100082166588573","61561511715916"];
if (!permission.includes(event.senderID)) return api.sendMessage("xin lỗi, bạn ko đủ tuổi để dùng lệnh này:>", event.threadID, event.messageID);
